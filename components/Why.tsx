        ...
        <>
            <div className='px-2 pt-4 pb-2 sm:px-32 sm:pt-20 sm:pb-4 bg-white relative sm:bottom-[165px]'>
                <div className='flex flex-col sm:flex-row items-center'>
                    <div className='flex flex-col shadow-lg justify-center items-start w-full sm:w-3/12 sm:pr-12 bg-[#222222] rounded-2xl px-8 py-6 sm:px-10 sm:py-20'  data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className='flex flex-col sm:flex-row w-full sm:w-9/12 sm:pl-10 bg-[#F9F9F9] py-2 sm:py-0 rounded-r-2xl' data-aos="fade-left" data-aos-duration="1000">
