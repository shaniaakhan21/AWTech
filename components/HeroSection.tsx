...
const HeroSection: React.FC<HeroSectionProps> = ({ title, buttonText1, buttonText2 }) => {
    ...
    useEffect(() => {
        AOS.init({
            ...
            once: true, // Animation will occur once when in viewport
        });
        AOS.refresh();
    }, []);
    ...
    return (
        ...
        >
            <div className="container w-full sm:w-1/2 pl-4 bg-[#00000045] sm:bg-transparent px-[4px] pb-20 pt-20 sm:px-0 sm:pb-0 sm:pt-0">
                <div className="text-white mb-4 sm:mb-8" data-aos="fade" data-aos-duration="2000">
                    ...
                    <p className="text-xs sm:text-sm mb-1 sm:mb-8 w-9/12 sm:w-10/12">
                        Abdul Waqas Technical Services LLC is a committed Facilities Management company responsible for all general building management.
                    </p>
                </div>

                <div className="flex flex-row justify-between mb-4 sm:mb-8" data-aos="fade-up" data-aos-duration="3000">
                ...
                <div className="flex flex-row justify-start items-center" data-aos="fade-up" data-aos-duration="3000">
